package com.github.dwyane.excel.utils;
...
import com.github.dwyane.exception.ExcelException;
import com.github.dwyane.utils.BrowseUtil;
import com.github.dwyane.utils.DateUtil;
...
public class ExcelToolUtil {
    ...
    public static <T> void writeExcel(HttpServletRequest request, HttpServletResponse response, List<T> dataList,
        ...
        String fileName = DateUtil.localDateMillisToString(LocalDateTime.now());
    ...
    private static OutputStream getOutputStream(String fileName, HttpServletRequest request,
        ...
        try {
            ...
            response.addHeader(HttpHeaders.CONTENT_DISPOSITION,
                    BrowseUtil.getDownName(request, fileName + excelTypeEnum.getValue()));
